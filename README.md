...
| [aws_s3_access_point.example](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/s3_access_point) | resource |
...
| <a name="input_access_point_origin"></a> [access\_point\_origin](#input\_access\_point\_origin) | The origin of the S3 Access Point. Valid values are 'internet' or 'vpc'. | `string` | `"Internet"` | no |
...
| <a name="input_bucket_account_id"></a> [bucket\_account\_id](#input\_bucket\_account\_id) | The account ID of the S3 bucket. | `string` | `""` | no |
...
| <a name="input_enable_access_point"></a> [enable\_access\_point](#input\_enable\_access\_point) | Whether to enable the creation of the S3 Access Point. | `bool` | `false` | no |
...
| <a name="input_policy"></a> [policy](#input\_policy) | The policy document for the S3 Access Point. | `string` | `""` | no |
...
| <a name="input_s3_access_point_name"></a> [s3\_access\_point\_name](#input\_s3\_access\_point\_name) | Name of the S3 Access Point. | `string` | `""` | no |
...
| <a name="input_vpc_id"></a> [vpc\_id](#input\_vpc\_id) | The ID of the VPC to associate with the S3 Access Point. | `string` | `""` | no |
