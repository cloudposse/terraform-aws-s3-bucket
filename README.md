...
| <a name="input_enforce_modern_tls"></a> [enforce\_modern\_tls](#input\_enforce\_modern\_tls) | Set to `true` to require that requests use a modern encryption protocol for data in transit (TLS version 1.2 or higher) | `bool` | `false` | no |
