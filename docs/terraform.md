...
| <a name="input_cloudtrail_bucket_policy_enabled"></a> [enable\_cloud\_trail\_bucket\_policy](#input\_enable\_cloud\_trail\_bucket\_policy) | Setting this to true allows cloud trail service to write to the log by applying the appropriate bucket policy | `bool` | `false` | no |
