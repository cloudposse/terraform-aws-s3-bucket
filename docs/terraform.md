...
| <a name="input_enable_cloud_trail_bucket_policy"></a> [enable\_cloud\_trail\_bucket\_policy](#input\_enable\_cloud\_trail\_bucket\_policy) | Setting this to true allows cloud trail service to write to the log by applying the appropriate bucket policy | `bool` | `false` | no |
