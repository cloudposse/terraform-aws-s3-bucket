...
| <a name="input_s3_replication_permission_boundary_arn"></a> [s3\_replication\_permission\_boundary\_arn](#input\_s3\_replication\_permission\_boundary\_arn) | Permission boundary ARN of the IAM replication role. Defaults to null. | `string` | `null` | no |
