...
resource "aws_s3_bucket" "default" {
  ...
  #bridgecrew:skip=BC_AWS_S3_16:Skipping `Ensure all data stored in the S3 bucket have versioning enabled` due to bug with evaluation of variable default value.
